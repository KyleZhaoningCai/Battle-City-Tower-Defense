...
class GameScene: SKScene {
    ...
    func setUpStaticTiles(){
        ...
        var river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -25, y:  (screenHeight!) / 2 - 1075)
        addChild(river1)
        ...
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 75, y:  (screenHeight!) / 2 - 1075)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 125, y:  (screenHeight!) / 2 - 1075)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 175, y:  (screenHeight!) / 2 - 1075)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 175, y:  (screenHeight!) / 2 - 1125)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 175, y:  (screenHeight!) / 2 - 1175)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 175, y:  (screenHeight!) / 2 - 1225)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 175, y:  (screenHeight!) / 2 - 1275)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: 175, y:  (screenHeight!) / 2 - 1325)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -175, y:  (screenHeight!) / 2 - 1325)
        ...
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -25, y:  (screenHeight!) / 2 - 1125)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -25, y:  (screenHeight!) / 2 - 1175)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -25, y:  (screenHeight!) / 2 - 1225)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -25, y:  (screenHeight!) / 2 - 1275)
        addChild(river1)
        river1 = SKSpriteNode(imageNamed: "river")
        river1.size = CGSize(width: 50, height: 50)
        river1.position = CGPoint(x: -25, y:  (screenHeight!) / 2 - 1325)
        addChild(river1)
